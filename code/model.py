...
class PGMR(nn.Module):
    def __init__(self, opts=None):
        ...
        lr = 0.0001
        # encoders
        self.model_orign = opts.modal_orign
        self.model_target = opts.modal_target
        self.DM = regis_model(model_orign=self.model_orign, model_target=self.model_target)#配准
