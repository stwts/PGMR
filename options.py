...
class MyOptions():
  def __init__(self):
    ...
    # data loader related
    self.parser.add_argument('--dataroot_MSRS', default='/mnt/c/Users/Administrator/Desktop/PGMR/train_dataset/test_MSRS', type=str)
    self.parser.add_argument('--dataroot_PET_MRI', default='/mnt/c/Users/Administrator/Desktop/PGMR/train_dataset/test_PET_MRI', type=str)
    self.parser.add_argument('--dataroot_SPECT_MRI', default='/mnt/c/Users/Administrator/Desktop/PGMR/train_dataset/test_SPECT_MRI', type=str)
    self.parser.add_argument('--dataroot_VI_SAR', default='/mnt/c/Users/Administrator/Desktop/PGMR/train_dataset/test_VI_SAR', type=str)
    self.parser.add_argument('--dataroot_test', default='/mnt/c/Users/Administrator/Desktop/PGMR/test_dataset', type=str)
    ...
    self.parser.add_argument('--result_dir', type=str, default='/mnt/c/Users/Administrator/Desktop/PGMR/results', help='path for saving result images and models')
    ...
    # training related
    self.parser.add_argument('--resume', type=str, default="/mnt/c/Users/Administrator/Desktop/PGMR/checkpoint/regis_all.pth", help='specified the dir of saved models for resume the training')
    ...
    self.parser.add_argument('--resume_enhancer', type=str, default="/mnt/c/Users/Administrator/Desktop/PGMR/checkpoint/enhancer.pth", help='specified the dir of saved models for resume the training')
